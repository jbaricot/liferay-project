...
/**
 * Provides the local service interface for formulario. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see formularioLocalServiceUtil
...
public interface formularioLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link formularioLocalServiceUtil} to access the formulario local service. Add custom service methods to {@link com.jbaricot.formulario.service.impl.formularioLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	public formulario createformulario(long formularioId);
	...
	*/
	...
	public formulario deleteformulario(formulario formulario);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public formulario deleteformulario(long formularioId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public formulario fetchformulario(long formularioId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public formulario fetchformularioByUuidAndGroupId(java.lang.String uuid,
		long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public formulario getformulario(long formularioId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public formulario getformularioByUuidAndGroupId(java.lang.String uuid,
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<formulario> getformularios(int start, int end);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<formulario> getformulariosByUuidAndCompanyId(
