...
/**
 * Provides the local service interface for prueba. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see pruebaLocalServiceUtil
...
public interface pruebaLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link pruebaLocalServiceUtil} to access the prueba local service. Add custom service methods to {@link com.liferay.suma.service.impl.pruebaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public prueba fetchpruebaByUuidAndGroupId(java.lang.String uuid,
		long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public prueba getpruebaByUuidAndGroupId(java.lang.String uuid, long groupId)
		throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<prueba> getpruebasByUuidAndCompanyId(java.lang.String uuid,
		long companyId);
